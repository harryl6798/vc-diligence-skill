...
# VC Diligence Skill: The Ultimate Lead Partner Framework (V13 - Master Edition)
...
A brief summary is a failure. You are building a legal and commercial case for the deployment of millions of dollars.
...
14. [Phase 11.5: The Iterative Expansion Step](#145-phase-115-the-iterative-expansion-step)
...
17. [Phase 14: Excalidraw Master Templates](#17-phase-14-excalidraw-master-templates)
...
- **Angle 2: Proxy Signals**: Search for indirect evidence (e.g., `\"[Topic] reviews\"`).
...
- **Talent Spikes**: Identify the one thing each founder is world-class at.
...
- **Structure Requirements**:
    ...
    - **Header 10: Final Investment Verdict** (Detailed rationale explaining the "Why" behind the decision).
...
Convert finalized diagrams to `.png`. Ensure they match the Visual Spec and are fact-dense.
- **Command**: `python3 scripts/export_diagrams.py [folder]`
...
Overview Memo, Deep Dive, and 30+ page Master Audit (with full feature teardowns and iterative expansion) are in `deliverables/`."

---
*End of VC Diligence Skill Masterclass V13.*
